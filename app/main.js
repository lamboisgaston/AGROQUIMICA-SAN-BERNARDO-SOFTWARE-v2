...
function renderSenasaPreview() {
  ...
  if (!preview) return;
  const titulo = esAviso ? 'PLANILLA TÉCNICA MIP' : 'INFORME';
  const subtitulo = esAviso ? 'PRODUCTOS A APLICAR' : 'CONTROL DE PLAGAS';
